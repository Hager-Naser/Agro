...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        <a class="desktop-logo logo-light active" href="{{ url('/' . ($page = 'index')) }}"><img src="{{ asset('assetUser/images/logo.png') }}"
            class="h-logo img-fluid blur-up lazyload main-logo" alt="logo"></a>
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            @can('All Products')
                <li class="slide">
                    <a class="side-menu__item" href="{{ route('products.index') }}"><svg
                            xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                            <path d="M0 0h24v24H0V0z" fill="none" />
            ...
            @can('All Categories')
                <li class="slide">
                    <a class="side-menu__item" href="{{ route('categories.index') }}"><svg
                        ...
                        </svg><span class="side-menu__label">All Categories</span></a>
                </li>
            @endcan
            @can('All Sub Categories')
                <li class="slide">
                    <a class="side-menu__item"  href="{{ route('subcategories.index') }}"><svg
                            xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                        ...
                        </svg><span class="side-menu__label">All Sub Categories</span></a>
                </li>
            @endcan
            @can('All Users')
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a class="slide-item" href="{{ url('/' . ($page = 'users')) }}">All Users</a></li>
