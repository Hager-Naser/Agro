                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName" name="name"
                                    title="Enter Product Name" required>
                            </div>
...
{{-- <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" id="exampleTextarea" name="details" rows="3"></textarea>
                            </div>
                        </div><br>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="price" name="price"title="Enter Price "
                                    required>
                            </div>
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="discount"
                                    name="discount"title="Enter Discount " required>
                            </div>
                        </div><br>
    ...
    <div class="row row-sm">
        ...
        <div class="col-lg-12 col-xl-5">
            <div class="card card-dashboard-map-one">
                ...
                <span class="d-block mg-b-20 text-muted tx-12">Sales Performance of all states in the United
                    States</span>
                <div class="">
        ...
        <div class="col-xl-4 col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header pb-1">
                    ...
                    <p class="tx-12 mb-0 text-muted">A customer is an individual or business that purchases the
                        goods
        ...
        <div class="col-xl-4 col-md-12 col-lg-6">
            <div class="card">
                <div class="card-header pb-1">
                    ...
                    <p class="tx-12 mb-0 text-muted">Sales activities are the tactics that salespeople use to
                        achieve
                        their
    ...
    <div class="container">
        ...
        <form action="{{ route('products.store') }}" method="POST">
            ...
            <div class="name_input mt-3">
                ...
                <input type="text" class="w-100" name="name" id="name" placeholder="Enter Product Name" >
            </div>

            <div class="price_input mt-3">
                <label for="Price" class="d-block">Products Price</label>
                <input type="number" class="w-100" name="price" id="Price" placeholder="Enter Product Price" >
            </div>
            <div class="price_input mt-3">
                <label for="Price" class="d-block">Products Discount</label>
                <input type="text" class="w-100" name="discount" id="discount" placeholder="Enter Product Discount" >
            </div>
            <div class="desc mt-3">
                <label for="desc" class="d-block">Products Details</label>
                <textarea id="desc" name="details" class="w-100" placeholder="Enter Product Details" ></textarea>
            </div>

            <input type="submit" class="mt-3" value="Add Product">
        </form>
    </div>
</section>
@endsection
