                                    ...
                                    <div class="col-lg-2">
                                        <div class="details-image-vertical black-slide rounded">
                                            ...
                                            @foreach ($productsSame as $productSame)
                                                <?php $i++; ?>
                                                @if ($i < 30)
                                                    @if ($productSame->category_id == $product->category_id)
                                                        <div>
                                                            <img src="{{ asset('assets/images/' . $productSame->image) }}"
                                                                class="img-fluid blur-up lazyload"
                                                                alt="{{ $productSame->name }}">
                                                        </div>
                                                    @endif
                                                @endif
                                            @endforeach
                                    ...
                                    <div class="col-lg-10">
                                        <div class="details-image-1 ratio_asos">
                                            <div>
                                                <img src="{{ asset('assets/images/' . $product->image) }}"
                                                    id="zoom_01"
                                                    data-zoom-image="{{ asset('assets/images/' . $product->image) }}"
                                                ...
                                                @if ($i < 30)
                                                    @if ($productSame->category_id == $product->category_id)
                                                        <div>
                                                            <img src="{{ asset('assets/images/' . $productSame->image) }}"
                                                                id="zoom_02"
                                                                data-zoom-image="{{ asset('assets/images/' . $productSame->image) }}"
                                    ...
                                    <div class="details-image-1">
                                        <div class="slick-slide">
                                            ...
                                            <h3 class="price-detail">
                                                <del>${{ $product->price }}</del><span>{{ $product->discount }}% off</span>
                                            </h3>

                                            <form id="cartOrWish" action="" method="POST">
                                                {{ csrf_field() }}
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-prepend">
                                                                <button type="button" class="btn quantity-left-minus"
                                                                    onclick="updateQuantity()" data-type="minus"
                                                                    data-field="">
                                                            ...
                                                            <span class="input-group-prepend">
                                                                <button type="button" class="btn quantity-right-plus"
                                                                    onclick="updateQuantity()" data-type="plus"
                                                                    data-field="">
                                                ...
                                                <div class="product-buttons">
                                                    ...
                                                    <button type="submit" id="" class="btn btn-solid hover-solid " formaction="{{ route('wishlistStore') }}"
                                                        style="">
                                                    ...
                                                    <button type="submit" id=""
                                                        class="btn btn-solid hover-solid btn-animation" style="" formaction="{{ route('cartStore') }}">
                                    ...
                                    @foreach ($productsSame as $productSame)
                                        ...
                                        @if ($i < 30)
                                            @if ($productSame->category_id == $product->category_id)
                                                <div class="slick-slide">
                                                    <div class="details-image-concept">
                                                        <h2>{{ $productSame->name }}</h2>
                                                    </div>


                                                    <h3 class="price-detail">
                                                        <del>${{ $productSame->price }}</del><span>{{ $productSame->discount }}%
                                                            off</span>
                                                    </h3>
                                                    <div id="selectSize"
                                                        class="addeffect-section product-description border-product">
                                ...
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        ...
                                        <div class="cart-wrap">
                                            <form action="" method="post">
                                                @csrf
                                                <input type="hidden" name="user_id" value="{{ Auth::user()->id }}">
                                                <input type="hidden" name="product_id" value="{{ $productSame->id }}">
                                                <input type="hidden" name="price" value="{{ $productSame->price }}">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <div class="main-price">
                                            ...
                                            <h3 class="theme-color">${{ $productSame->price }}</h3>
